...
p.nominalBounds = new cjs.Rectangle(0,0,561,322);
...
(lib.gun2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-223,-120,0.6512,0.6518);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.gun2, new cjs.Rectangle(-223,-120,365.4,209.9), null);
...
(lib.levelcomplete = function(mode,startPosition,loop) {
	...
	this.frame_76 = function() {
		...
		var gotourl;
			if(mobile) {
			gotourl = "https://m.1000webgames.com/?utm_campaign=assault_zone_html5&utm_medium=moregames_starplevel&utm_source=" + ref;	
			} else {
			gotourl = "https://1000webgames.com/?utm_campaign=assault_zone_html5&utm_medium=moregames_starplevel&utm_source=" + ref;
			}
...
p.nominalBounds = new cjs.Rectangle(228.5,254.6,456.6,422.4);
...
(lib.webgamespreloader = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function merePreloader()
		{
			...
			var gotourl;
			if(mobile) {
			gotourl = "https://m.1000webgames.com/?utm_campaign=assault_zone_html5&utm_medium=preloader&utm_source=" + ref;	
			} else {
			gotourl = "https://1000webgames.com/?utm_campaign=assault_zone_html5&utm_medium=preloader&utm_source=" + ref;
			}
			window.open(gotourl, "_blank");
		}
	}
...
}).prototype = getMCSymbolPrototype(lib.onScreen, new cjs.Rectangle(3.9,0,627.8000000000001,418.4), null);
...
p.nominalBounds = new cjs.Rectangle(320,180,338.1,238.39999999999998);
// library properties:
lib.properties = {
