...
var targetScores = [801,833,859,922,930,1002,1027,1027,1041,1055];
...
function readMemory() {
	...
	for (i = 0; i < levelScores.length; i++) {
		if(localStorage.getItem('scoreparktaxi2' + i) == null) localStorage.setItem('scoreparktaxi2' + i, 0);
    levelScores[i] = parseInt(localStorage.getItem('scoreparktaxi2' + i));
	}
	updateAchievements();
}
// ------------------------------------------------------------------------------
function writeMemory() {
		for (i = 0; i < levelScores.length; i++) {
    localStorage.setItem('scoreparktaxi2' + i, levelScores[i]);
	}
	updateAchievements();
}
