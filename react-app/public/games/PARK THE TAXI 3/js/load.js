...
setTimeout(function(){
			...
			var maxPlatums = 2.195;
			if (iw > ih * maxPlatums) iw = ih * maxPlatums;// max speles platums
			...
			if (iw == ih * maxPlatums) anim_container.style.width = iw = ih * maxPlatums +'px';// max speles platums
