      ...
      >
        {slides.map((slide, i) => (
          <div key={i} className="mobile-hero-slide">
            ...
            {/* ============================================================
                PERF FIX (Step 5 / Step 4): Banner slide image optimisation.
                - Added width="800" height="400" to reserve space before load
                  → prevents CLS (layout shift when image loads).
                - First slide (i === 0) gets fetchpriority="high" and
                  loading="eager" — it's the hero LCP element on mobile.
                - All other slides keep loading="lazy" (unchanged behaviour).
