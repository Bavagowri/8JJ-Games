    ...
    <div className="MainLoginWrapper">
      ...
      <div className="auth-page">
          ...
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              {showForgotPassword ? (
                ...
                <>
                  Welcome Back to
                  <br />
                  <span className="hero-highlight">Epic Gaming</span>
                </>
              )}
            </h1>
            ...
            <p className="hero-description">
              {showForgotPassword 
                ...
                : "Continue your adventure with 9000+ free games at your fingertips. Jump back into the action instantly!"
              }
            </p>
        ...
        <div className="form-section">
          <div className={`form-container ${showForgotPassword ? 'forgot-active' : ''}`}>
            
            {/* LOGIN FORM */}
            <div className={`form-panel login-panel ${showForgotPassword ? 'hidden' : 'active'}`}>
              <h2 className="form-title">Welcome Back</h2>
              <p className="form-subtitle">Log in to continue your gaming journey</p>
            ...
            <div className={`form-panel forgot-panel ${showForgotPassword ? 'active' : 'hidden'}`}>
