// react-app/src/pages/TermsOfService/TermsOfService.jsx
...
const DESCRIPTION =
  "Read the Terms of Service for 8JJ Games. Learn what governs your use of our free sports prediction and online gaming platform, including contest rules, account policies, and user responsibilities.";
const KEYWORDS =
  "8JJ Games terms of service, gaming platform terms, sports prediction rules, user agreement, account policies, contest rules, online gaming terms";
...
export default function TermsOfServicePage() {
  ...
  return (
    <>
      {/* ── HEAD: Full SEO meta, OG, Twitter, canonical, schema ── */}
      <Helmet>
        {/* Primary meta */}
        ...
        <meta property="og:image:alt"   content={`${SITE_NAME} - Terms of Service`} />
        ...
        <meta name="twitter:image:alt"   content={`${SITE_NAME} - Terms of Service`} />
      ...
      <main id="main-content" aria-label="Terms of Service">
        ...
        {/* Accessible skip-nav target (pair with a skip link in your shell) */}
        ...
        >
          ...
          <TermsOfServiceContent lang={lang} />
        </article>
